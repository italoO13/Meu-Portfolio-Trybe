...
//     return console.log(`Mars temperature is: ${temperatura} degree Celsius`);
// }
...
// const sendMarsTemperature = (temperaturaFa,handleErro) => {
//     const temperatura = getMarsTemperature();
//     setTimeout(() => {
//         if (Math.random() <= 0.6) {
//             return handleErro('Deu ruim');
//         }
//         return temperaturaFa (temperatura);
